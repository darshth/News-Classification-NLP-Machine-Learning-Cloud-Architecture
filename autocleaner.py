...
The code can furthered be modularized to set a dynamic working directory.
"""
...
if __name__ == '__main__':
    df = pd.read_csv("/Users/darshthakkar/Downloads/" + input7)
    ...
    print(df)
    """
    df.to_csv("/Users/darshthakkar/Downloads/cleanedtest.csv")
    """